...
async def start_command(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    text = '''سلام! 👋  
من *مستر میستری* هستم، یک کارآگاه هوش مصنوعی که با جدیدترین مدل‌های زبانی، داستان‌های جنایی منحصر‌به‌فردی برای تو می‌سازم! 🔎  

🔹 هر داستان فقط برای تو خلق می‌شه و هیچ‌کس دیگه تجربه مشابهی نخواهد داشت.  
🔹 در هر مرحله، انتخاب‌هایی داری که مسیر داستان رو تغییر می‌ده و *غیرقابل‌بازگشته*! پس با دقت تصمیم بگیر!  

🎭 آماده‌ای وارد دنیای رازآلود من بشی؟ شروع کن و ببین چه معمایی در انتظارت هست! 🕵️‍♂️  '''
